...
export const MENU: MenuItem[] = [
    { id: 1001, label: 'Principal', isTitle: true },
    ...
    { id: 1002, label: 'Organización', isTitle: true },
    ...
    { id: 1003, label: 'Operación', isTitle: true },
    ...
    { id: 1004, label: 'Gestión comercial', isTitle: true },
    ...
    { id: 1005, label: 'Programas', isTitle: true },
    ...
    { id: 1006, label: 'Cuenta', isTitle: true },
